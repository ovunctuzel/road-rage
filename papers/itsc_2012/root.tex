...
\commentd{? UML diagram: 3 components with their capabilities listed inside, and
arrows of interactions between them?}
...
(\emph{edges}) as vertices and \emph{turns} as edges. \emph{Roads} are a
super-structure with meta-data, bundling several \emph{edges} together, and
