...
\commentd{space continuous? get terminology right}
...
\commentd{lazy queue checking for speedup. mention briefly?}
...
\commentd{describe traffic signal policy, once it's working fully. the delay
thing is maybe interesting.}
...
\commentd{this is now fixed in most cases. describe, and describe a better
  workaround for some cases: S turns}
\commentd{and describe the full-capacity case and how that's hopeless anyway}
