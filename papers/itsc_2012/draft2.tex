...
\begin{enumerate}
  ...
  \item Turns are next constructed between incoming and outgoing lanes at each
        ...
        like Google Maps \commentd{TODO cite} lack this information.
...
a route to some goal using standard A* search (\commentd{TODO cite}); the other
...
\commentd{wiki has a page naming gridlock. cite that for the name?}
...
applications could experiment with contra-flow \commentd{cite these all} and
micro-tolling. There will also be an effort to improve AORTA as a framework by
including a lane-changing model and preventing gridlock.
