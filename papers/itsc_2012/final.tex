...
\commentd{Previously, ``AORTA allows for the creation of intersection policies
  on top of a reservation based intersection manager \cite{JAIR08-dresner}, and
  these policies designate when agents can cross the intersection.'' Actually,
  reservations are just one policy. Do we want to focus on the general case
here, or autonomous specifically?}
...
%with zero initial speed. Because behaviors must enforce speed limit along a lane
