...
After exploring the state of the art \ref{sec:related_work} and explaining
the architecture of AORTA \ref{sec:arch} as well as its use of OSM \ref{sec:map},
we will describe simulation in AORTA \ref{sec:simulation} and how to extend it
\ref{sec:config}, concluding with an example experiment \ref{sec:results}.
