...
for autonomous vehicles demonstrated at the end of this paper.
\end{abstract}
...
AORTA aims to solve some of these problems by providing a sandbox in which such
methodologies can be found and tested for safety and efficiency before being
deployed in the real world.  In this manner, AORTA aids in the effort to find
...
\commentpk{Also do we still have point vehicles only?}
\commentd{Technically yes, but we could add in a check to make sure the fronts
  of every vehicle aren't too close to any other vehicle. It would just be
  needlessly expensive, and we trust the following-distance behavior.}
...
\commentd{So is this paragraph below still relevant?}
