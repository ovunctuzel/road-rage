...
\cite{JAIR08-dresner}.
\commentm{Given that SUMO is also open-source and seems to be used fairly commonly
in the traffic community, our only real advantage over it is actually our choice
of language.  AORTA is much easier to use and extend primarily because we use
a higher level language.  (As we mention, our intersections are also more general,
but I think that's actually less important.)  I'm not sure of how to handle this.}
...
following a simple acceleration-based dynamics model \commentpk{need ideas on
framing the last sentence better}.  Time is modeled discretely, and an
