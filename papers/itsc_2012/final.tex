...
clients, can easily be written in Java or Scala. The software is
open-source\footnote{http://code.google.com/p/road-rage} and easily extensible.
The stop sign policy used in Section \ref{sec:results}'s experiments is
implemented in just $70$ lines of code.
