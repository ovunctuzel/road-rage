...
where the demand supplied by individuals is taken as is.  Rather than simply improving
routes, AORTA allows entirely different behaviors for both vehicles and intersections.
...
with SUMO, AORTA also displays more robust handling of data exported directly from OSM. 
...
\cite{JAIR08-dresner}, which aims to optimize traffic flow of
...
city-wide scale to real-world road networks.

A few simulators focus on autonomous vehicles with sensors and actuators
...
that autonomous vehicles have reasonable sensory input and mechanical
output, and instead focuses on interactions between an agent and its
surrounding agents and intersections.
