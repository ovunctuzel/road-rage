...
interprets these points as straight line segmentss and projects parallel lanes
...
to be several in close proximity, since OSM only has geometric, not functional,
data on how roads meet. If OSM encoded this information, the realism of the
simulation would improve. Other simulators have dealt with similar issues before
...
actually are along that turn. This is visualized in Fig. \ref{fig:conflicts}.
